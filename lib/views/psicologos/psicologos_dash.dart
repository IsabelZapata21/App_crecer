...
import 'package:flutter_application_2/views/psicologos/listar_psicologos.dart';
class PsicoDashboard extends StatefulWidget {
  const PsicoDashboard({super.key});

  @override
  State<PsicoDashboard> createState() => _PsicoDashboardState();
}

class _PsicoDashboardState extends State<PsicoDashboard> {
  @override
      ...
      children: <Widget>[
        _buildOptionItem(
          ...
          () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => RegistroPsicologoScreen()),
            );
          },
        ),
        _buildOptionItem(
          ...
          () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => HistorialPsicologos()),
            );
          },
        ),
      ],
